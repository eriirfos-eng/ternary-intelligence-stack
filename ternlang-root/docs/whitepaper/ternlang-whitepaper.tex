...
autonomous surgeries into an 18-layer, 87M-parameter multilingual system (v3.0)
trained on eight languages across a 177M-token corpus (2915+ global epochs as of 2026-05-22). It serves as an empirical
...
Total parameters & $\approx$22M & $\approx$\textbf{87M} \\
...
\textbf{Surgery 6} & $\mathbf{17L \to 18L}$ $\cdot$ 32k vocab & \textbf{ep2487; Mandelbrot $c_\text{im}=+0.0099$; $\approx$87M params} \\
\bottomrule
\end{tabular}
\end{table}
...
Total parameters & $\approx$\textbf{87M} (ternary) \\
...
ternary MoE model confirmed at 17L (82M parameters) and persisting through Surgery~6 into
18L (87M parameters). The cross-lingual architecture precedes fluency---albert.\ has built
