...
\hypersetup{
  ...
  pdfauthor={Kepp, Karimi, Csonka, Ehrig --- RFI-IRFOS}
}
...
\fit{\begin{tabular}{@{}c@{\hspace{1.6em}}c@{\hspace{1.6em}}c@{\hspace{1.6em}}c@{}}
\textbf{Simeon Kepp} & \textbf{Zabih Karimi} & \textbf{Nikoletta Csonka} & \textbf{Louis Paul Ehrig}\\
{\footnotesize Lead Architect} & {\footnotesize IT \& Network Eng.} & {\footnotesize Intl.\ Relations} & {\footnotesize Public Affairs}\\
{\scriptsize\href{mailto:s.kepp@ternlang.com}{\texttt{s.kepp}}} & {\scriptsize\href{mailto:z.karimi@ternlang.com}{\texttt{z.karimi}}} & {\scriptsize\href{mailto:csonikoletta@ternlang.com}{\texttt{csonikoletta}}} & {\scriptsize\href{mailto:l.ehrig@ternlang.com}{\texttt{l.ehrig}}}\\
\end{tabular}}}
