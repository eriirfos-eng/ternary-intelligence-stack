...
\begin{tabular}{@{}c@{\hspace{1.6em}}c@{\hspace{1.6em}}c@{\hspace{1.6em}}c@{\hspace{1.6em}}c@{}}
...
{\scriptsize\texttt{s.kepp}} & {\scriptsize\texttt{z.karimi}} & {\scriptsize\texttt{csonikoletta}} & {\scriptsize\texttt{l.scharler}} & {\scriptsize\texttt{l.ehrig}}\\
\end{tabular}}
\thanks{All authors at RFI-IRFOS --- Research Focus Institute, Elisabethinergasse~25, 8020~Graz, Austria. Email: \texttt{<user>@ternlang.com}. LinkedIn: simeon-kepp, zabih-karimi, csonikoletta, lisa-scharler, louis-ehrig. Patent Pending A50296/2026 (TIS platform, 10 claims). Repository: \url{https://github.com/eriirfos-eng/ternary-intelligence-stack}}%
}
