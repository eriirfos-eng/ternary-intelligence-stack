...
fn stdlib_source_for(path: &[String]) -> Option<&'static str> {
    match path.join("::").as_str() {
        ...
        "qnn::entanglement" => Some(include_str!("../../stdlib/premium/qnn/entanglement.tern")),
        "qnn::qnn_circuit" => Some(include_str!("../../stdlib/premium/qnn/qnn_circuit.tern")),
        "qnn::qnn_layer" => Some(include_str!("../../stdlib/premium/qnn/qnn_layer.tern")),
        "qnn::qutrit" => Some(include_str!("../../stdlib/premium/qnn/qutrit.tern")),
        "qnn::variational" => Some(include_str!("../../stdlib/premium/qnn/variational.tern")),
        "reasoning::bayesian" => Some(include_str!("../../stdlib/premium/reasoning/bayesian.tern")),
        "reasoning::causal" => Some(include_str!("../../stdlib/premium/reasoning/causal.tern")),
        "reasoning::contradiction" => Some(include_str!("../../stdlib/premium/reasoning/contradiction.tern")),
        "reasoning::temporal" => Some(include_str!("../../stdlib/premium/reasoning/temporal.tern")),
        "reasoning::uncertainty" => Some(include_str!("../../stdlib/premium/reasoning/uncertainty.tern")),
