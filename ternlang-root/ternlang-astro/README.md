...
## The deliberative hold Vacuum
`ternlang-astro` solves the deep-space routing problem natively. When a packet is beamed across the solar system, the transmitting node does not enter a "Failure/Timeout" state. It transitions to `deliberative hold (InTransit)`. 
