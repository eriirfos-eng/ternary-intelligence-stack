...
3.  **The Genesis Tether:** The firmware must securely integrate the `verify_genesis_anchor()` heartbeat. If the Fly.io API is unreachable, the hardware must hard-lock into State 0.
