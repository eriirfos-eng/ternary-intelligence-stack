...
\centering
\small
\caption{Workspace crates, test counts, and brief descriptions (v0.2.0)}
\label{tab:status}
\begin{tabular}{p{2.5cm}lp{5.5cm}}
\toprule
Crate & Tests & Description \\
\midrule
\texttt{ternlang-core}    & 56  & Lexer, parser (+ \texttt{?} propagation), AST, semantic checker, BET VM (51 opcodes), ModuleResolver \\
...
We have presented Ternlang v0.2.0, a full-stack balanced ternary execution
