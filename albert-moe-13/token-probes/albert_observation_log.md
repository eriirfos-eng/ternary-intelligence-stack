...
## FN335 · 2026-05-31T14:08Z · post-cut FULLY re-converged — WALD mass back to 8.281 (= pre-surgery operating point); capacity restored, not yet exceeded · [watch tick, terse]
~34 min since FN334. The expansion has finished healing: **WALD mass walked all the way back down** — ep4749 8.382 → ep4750 8.345 → **ep4754 8.281** (13:54Z), essentially identical to the gate's pre-cut late_mean 8.2771. So the 29L model has recovered to *exactly* its pre-surgery operating point — whiplash fully gone, no regression, but **no net gain from the new layer yet either.** Sampled means confirm the flatness: ep4751–4756 = 8.4164 / 8.4770 / 8.4541 / 8.4584 / 8.4697 / 8.4589 — a tight 8.42–8.47 band (calibrated ~8.24 server), no break below the old plateau. This is the expected "recover-then-exploit" shape: post-Net2Net the model first re-attains prior loss, *then* (ideally) the added capacity opens new downward room — we're at the recover inflection now, watching for the exploit. Best EP-AVG ATL still 8.1835 (ep4670). WALD cadence 3/60min, last ep4754; csv fresh (~35 s, ep4756), dashboard 200, governor quiet, no `vestigial=N`. **Band has now steadied** → token-probe benchmark is viable again; will run it next tick if this holds (capture the 29L geometry vs the pre-surgery snapshot). Patient watch: the tell is a sampled mean printing <8.40 / WALD mass <8.27.

---

## FN334 · 2026-05-31T13:34Z · post-cut re-settling continues — whiplash absorbed, WALD mass declining (8.382→8.345); no new descent leg below old plateau YET · [watch tick, terse]
~17 min since FN333. The expansion is re-converging cleanly but hasn't paid off yet. **WALD:** mass coming back down off the post-cut bump — ep4749 8.382 (step300) → ep4750 8.345 (step600), counter advancing normally, fill 20.8% steady. **Sampled means:** whiplash fully absorbed — ep4749 8.5515 → ep4750 8.4581 → **ep4751 8.4164** (lowest post-cut; min 6.9918, a sub-7 batch) → ep4752 8.5092 (partial n=85). Net: oscillating the 8.41–8.55 band, marginally at/under the pre-cut 8.43 level but **not a sustained break below the old ~8.28 server plateau** — too noisy to call a new descent leg. Calibrated, sampled ~8.42 → server ~8.21, i.e. roughly back to where it was pre-cut; the added capacity hasn't yet opened new downward room. Best EP-AVG ATL still 8.1835 (ep4670). csv fresh (~40 s, ep4752), dashboard 200, governor quiet post-fire, no escalation, no `vestigial=N`. Need ~3–5 more clean epochs to see whether the larger model carves below 8.28; token-probe still deferred until the band steadies. Patient watch.
...
## FN318 · 2026-05-31T08:04Z · lower plateau holding, unchanged · [watch tick, terse]
No change: sampled means 8.42–8.48 (ep4706 8.4776, ep4707 8.4701, ep4708 8.4416), oscillation steady. WALD quiet since ep4703 (~56 min, stable coverage). No new ATL since ep4670 (8.1835, 03:24Z, ~280 min). csv fresh (08:03:39Z, ~27 s), at ep4708, HTTP 200, no divergence — healthy plateau, not a stall. No escalation. Still no `vestigial=N` (Modal-stdout only).

---

## FN317 · 2026-05-31T07:49Z · lower plateau holding, unchanged · [watch tick, terse]
No change: sampled means 8.42–8.50 (ep4704 8.4704, ep4705 8.4442), oscillation steady. WALD quiet since ep4703 (mass 8.282, ~41 min, stable coverage). No new ATL since ep4670 (8.1835, 03:24Z, ~265 min). csv fresh (07:48:34Z, ~32 s), at ep4706, HTTP 200, no divergence — healthy plateau, not a stall. No escalation. Still no `vestigial=N` (Modal-stdout only).
...
## FN314 · 2026-05-31T07:19Z · lower plateau holding, WALD mass pinned ~8.288, sampled easing down · [watch tick, terse]
Steady: WALD ep4700/4701 mass **8.287 / 8.289** — still pinned in the 8.284–8.294 band, under 8.30 (no regression leg). Sampled means easing slightly down (ep4700 8.4412 → ep4702 8.4180), so the upper-edge wobble is relaxing. No new ATL since ep4670 (8.1835, 03:24Z, ~235 min). csv fresh (07:19:03Z, ~3 s), at ep4702, HTTP 200, no divergence — healthy plateau, not a stall. No escalation. Still no `vestigial=N` (Modal-stdout only).
...
## FN309 · 2026-05-31T06:04Z · lower plateau holding, unchanged · [watch tick, terse]
No change: sampled means 8.41–8.49 (ep4690 8.4335, ep4691 8.4739), oscillation steady. WALD quiet since ep4689 (~26 min, stable coverage). No new ATL since ep4670 (8.1835, 03:24Z, ~160 min). csv fresh (06:02:43Z, ~82 s), at ep4692, HTTP 200, no divergence — healthy plateau, not a stall. No escalation. Still no `vestigial=N` (Modal-stdout only).

---

## FN308 · 2026-05-31T05:49Z · lower plateau holding, WALD mass at top of oscillation (8.278) · [watch tick, terse]
No change: WALD ep4689 mass **8.278** (top of the recent 8.246–8.278 oscillation — bounces, no regression trend). Sampled means 8.41–8.49 (ep4688 8.4932, ep4689 8.4156). No new ATL since ep4670 (8.1835, 03:24Z, ~145 min). csv fresh (05:47:59Z, ~65 s), at ep4690, HTTP 200, no divergence — healthy plateau, not a stall. No escalation. Still no `vestigial=N` (Modal-stdout only).
...
## FN305 · 2026-05-31T05:04Z · lower plateau holding, upper-band swing · [watch tick, terse]
No change: sampled means swung to upper band (ep4682 8.4795, ep4683 8.4936), still within the oscillation, no break. WALD quiet since ep4678 (~41 min, stable coverage). No new ATL since ep4670 (8.1835, 03:24Z, ~100 min). csv fresh (05:02:52Z, ~73 s), at ep4684, HTTP 200, no divergence — healthy plateau, not a stall. No escalation. Still no `vestigial=N` (Modal-stdout only).

---

## FN304 · 2026-05-31T04:49Z · lower plateau holding, oscillating, unchanged · [watch tick, terse]
No change: sampled means 8.39–8.49 (ep4680 8.4840, ep4681 8.4624). WALD quiet since ep4678 (~26 min, stable coverage). No new ATL since ep4670 (8.1835, 03:24Z, ~85 min). csv fresh (04:47:51Z, ~76 s), at ep4682, HTTP 200, no divergence — healthy plateau, not a stall. No escalation. Still no `vestigial=N` (Modal-stdout only).
...
### [overnight loop · iter 2] ~02:16 CEST — wide-swing exploration, mass drifting down
- **ntfy:** WALD ep4786 (mass 8.239) → ep4787 (**mass 8.231**, lowest of the post-restart series 8.242→8.255→8.239→8.231). fill 18.8–20.8%, dead bands stable, still "sever" but NOT escalating.
- **bitstream (batch_history, the live stream):** last batches swinging **7.45 ↔ 8.91**; min over the recent ~1500-row window = **6.9579**. high variance with deep low-mins.
- **note:** `dashboard/training.log` is STALE (shows ep17L/global1357 = a prior run). live = batch_history + ntfy + dashboard. don't read training.log for current state.
- **AdamW-reset study — live data point (for Simeon's hypothesis):** the post-29L state shows exactly the reset signature — *wide un-normalized swings* (±1.5 around ~8.2) with batches discovering very low loss (6.96). that is the exploration energy a fresh AdamW (tiny `v`) produces. mass slow-drifting down (8.255→8.231) = selection narrowing while exploration continues. NOT yet reclaimed the best epoch-avg ATL (~8.18); EP-AVG ~8.2266 vs mass 8.231. consistent with "reset = healthy downward kick + selection," not yet conclusive.

### [overnight loop · iter 3] ~02:23 CEST — skew revealed, plateau still high-variance
- **ntfy:** WALD ep4788 mass **8.239** — holding (8.231→8.239), stable, not climbing.
- **clean per-epoch RAW means (current run):** ep4777–4788 = 8.43–8.52, roughly **flat ~8.45**. ep4789 = 8.32 but n=127 (partial, ignore).
- **KEY METRIC INSIGHT:** raw per-epoch mean (~8.45) sits **well above** the WALD mass / dashboard EP-AVG (~8.23). The distribution is **right-skewed** — spikes (8.9–10.2) drag the mean up while the robust central mass holds ~8.23. So "EP-AVG" on the dashboard is a robust central estimate (median/trimmed/mass), NOT the raw mean. Track BOTH: raw mean = variance/spike load; mass = where the bulk actually sits. The descent leg will show first in the mass, then the mean as spikes subside.
- **read:** still on the high-variance exploration plateau (raw mean flat ~8.45), robust mass inching down (8.255→8.231→8.239). The AdamW-reset exploration is active but selection has NOT yet converged into a clean descent.
- **AdamW study, method finding:** `dashboard/batch_history.csv` is a CONCATENATION across runs (epoch numbers repeat; can't bin globally). For prediction #1 (past surgery→restart descent), the right data = the per-run CSVs `~/Desktop/Downloads/albert_full_*.csv` (each = one session/run). NEXT ITER: measure a past run's post-reset descent slope from one of those.

### [overnight loop · iter 4] ~02:30 CEST — AdamW study prediction #1: reference numbers
- **ntfy:** WALD ep4789 mass **8.230** (new low: 8.255→8.239→8.230). raw epoch-means tilting down (8.50→8.37→8.40). early descent surfacing.
- **AdamW-reset descent test (prediction #1), from per-run CSV `albert_full_1780210700385`:**
  - **28L reference run** (epoch-summary section): first **9.3947** → best **8.1835 @ ep4670** → ended **8.2986 @ ep4698**. Descent 9.39→8.18 over ~1171 epochs, then the 28L→29L surgery.
  - **29L current run** (post safe-copy surgery + AdamW reset): started ~**8.25** (NOT a 9.39-style jump — Net2Net is function-preserving, so the surgery kept the loss near the 28L endpoint). now **8.230 @ ep4789**, i.e. **+0.047 above the 28L best (8.1835)**, drifting down.
- **reading on Simeon's hypothesis:** the kick magnitude scales with how function-preserving the surgery is. The 28L run shows a BIG post-reset descent (9.39→8.18) — a large kick. The 29L safe-copy shows a GENTLE one (8.30→8.25→8.23) — small kick, because function was preserved. In BOTH, the reset's wide-swing exploration (batches 7.45–8.91, lows to 6.96) runs while the mass descends. **The 29L is descending toward the prior best WITHOUT any manual wait-pause-pull — exactly the "let the reset do the selection" thesis.** Falsifiable watch: mass crossing **below 8.1835** = reset+selection beat the prior best with zero intervention (supports). Mass stalling >8.20 = needs the manual momentum-build after all (against).
- [iter 5] ~02:37 — mass 8.237 (osc 8.23–8.24), raw mean ~8.42, ep4791. NO crossing below 8.1835 yet; steady high-variance plateau.
...
- [iter 10] ~03:12 — quiet. mass 8.238 (no new WALD ~9min), raw mean ~8.44 (faint downtick 8.48→8.44), ep4797. flat plateau, no crossing/event.
...
- [iter 15] ~03:47 — calm. WALD silent, raw mean ~8.45 (noise), ep4803, mass 8.238. flat plateau holding, no crossing/event.
- [iter 16] ~03:54 — calm. WALD silent, raw mean ~8.43 (ep4804 partial 8.39, faint dip?), mass 8.238. flat plateau, no crossing/event.
- [iter 17] ~04:01 — calm. dip hint resolved to noise (ep4804 full=8.43). WALD silent, raw mean ~8.45, ep4805, mass 8.238. flat plateau, no crossing/event.
...
- [iter 26] ~05:04 — WALD silent, raw mean ~8.43, ep4815, mass ~8.24. descent parked on plateau, no crossing below 8.1835.
- [iter 27] ~05:11 — WALD @ep4816 mass 8.268 (NEW band-high, ceiling drifting up). raw mean steady ~8.43, ep4817, no collapse. descent stalled ~0.08 above 8.1835, marginally rising. verdict firming: gentle reset alone (fn-preserving surgery) did NOT beat prior best without intervention.
- [iter 28] ~05:18 — unchanged. mass 8.268 (parked at elevated band-high), raw mean ~8.45, ep4818. descent stalled, no crossing below 8.1835. ~4h watch.
...
- [tick 2026-06-03T22:14:18Z] ⚠ STALL FLAG: ntfy SILENT ~30 min. Last msg still WALD ep4928 @ 21:43 (mass 8.147), same as last tick — ~4 missed WALD intervals (normal cadence ~7min). EITHER the Modal training loop stalled/paused/preempted, OR the ntfy telemetry publisher died while training continues. Cannot distinguish from ntfy alone. Per instructions: NOT redeploying / NOT restarting — flagged to Simeon to check Modal. Last healthy state: descending, mass 8.147, no divergence before the silence.

- [tick 2026-06-03T22:29:29Z] STALL FLAG DOWNGRADED - training is ALIVE. ntfy still silent (45min, stuck ep4928 @21:43) BUT local dashboard/batch_history.csv mtime 22:27:58 advanced to ep4935 (batch loss ~8.58-8.89, descending). Conclusion: the ntfy telemetry PUBLISHER died/stopped at 21:43; the Modal training loop itself is fine and progressing. ntfy now unreliable as a monitor - leaning on local batch_history. CAVEAT: cannot 100% rule out batch_history advance being a merge-job vs live stream, but recent mtime + epoch just past ntfy strongly indicates live training. No divergence (batch losses in normal noise band). Not restarting anything per instructions.

- [tick 2026-06-03T23:11:05Z] ntfy STILL silent (~1.5h, publisher down since 21:43 - NOT training). Local batch_history.csv live (mtime 23:10) advanced ep4935->ep4941, batch loss 8.03-8.60 (normal noise band, descending). Training healthy + progressing, no stall/divergence. Continuing to watch via local batch_history since ntfy remains unreliable. Not touching anything.

- [tick 2026-06-03T23:28:44Z] ntfy still silent (~1.75h, publisher down). batch_history fresh (mtime 23:27): ep4941->ep4943.7, batch loss 7.96/8.01 - DIPPING under 8.0, lower than last tick (8.03-8.60). Descent continuing, healthy, no stall/divergence. Watching via local data.
...
- [tick 2026-06-04T00:58:40Z] No change: ntfy still down (~2h), training healthy via batch_history (mtime 00:58) ep4956.8, loss 8.55-8.85 normal band. Advancing, no stall/divergence.

- [tick 2026-06-04T01:13:51Z] Batch loss NEW LOW for this watch: 7.06 (was 7.81 earlier) - descent deepening. batch_history live (mtime 01:12) ep4958.9. ntfy flickered back (1 WALD ep4956 mass 8.177 fill 20.8  (prev line truncated by a shell printf escape) ...fill ~21 pct, still lagging/intermittent. Net: healthy, no stall/divergence.

- [tick 2026-06-04T01:28:43Z] ntfy recovering - fresh WALD ep4960 mass 8.169 fill ~21 pct, gap down to 1min (catching up). batch_history (mtime 01:27) ep4961, loss 8.09-8.71 normal band (back up from the 7.06 dip, just noise). Healthy, advancing, no stall/divergence.
...
- [tick 2026-06-04T02:28:51Z] No change: ntfy lagging badly (ep4964, 33min gap, ~5 epochs behind), training healthy via batch_history (mtime 02:28) ep4969.8, loss dipping 7.50 (descent continuing). No stall/divergence.

- [tick 2026-06-04T02:43:54Z] No change: ntfy silent again, training healthy via batch_history (mtime 02:43) ep4971.9, loss 7.93-8.15 normal band. Advancing, no stall/divergence.

- [tick 2026-06-04T02:58:53Z] No change: ntfy silent, training healthy via batch_history (mtime 02:58) ep4974.1, loss 8.56-9.00 normal band. Advancing, no stall/divergence.

- [tick 2026-06-04T03:13:57Z] No change: ntfy intermittent (WALD ep4974 mass 8.180, 9min gap), training healthy via batch_history (mtime 03:12) ep4976.2, loss 8.17-8.42 normal band. Advancing, no stall/divergence.

- [tick 2026-06-04T03:28:57Z] No change: ntfy lagging (ep4974, 24min gap), training healthy via batch_history (mtime 03:27) ep4978.3, loss dipping 7.33 (descent intact). No stall/divergence.

- [tick 2026-06-04T03:43:43Z] No change: ntfy silent, training healthy via batch_history (mtime 03:42) ep4980.5, loss 7.42-8.02 normal band. Advancing, no stall/divergence.

- [tick 2026-06-04T03:58:48Z] No change: ntfy intermittent (WALD ep4980 mass 8.160, 12min gap), training healthy via batch_history (mtime 03:58) ep4982.8, loss 7.57-8.67 normal band. Advancing, no stall/divergence.

- [tick 2026-06-04T04:13:52Z] No change: ntfy lagging (ep4980, 28min gap), training healthy via batch_history (mtime 04:13) ep4985, loss 8.17-8.75 normal band. Advancing, no stall/divergence.

- [tick 2026-06-04T04:28:52Z] No change in posture: ntfy silent, training healthy via batch_history (mtime 04:28) ep4987.1, loss 7.19-7.46 (low-7s, descent holding near watch-low). No stall/divergence.
